...
import { generateWordGuessQuestions } from "@/actions/wordGuess";
...
export default function StartPage() {
  ...
  useEffect(() => {
    ...
    const createQuestions = async () => {
      ...
      formData.append("type", questionsConfig.type || "japan-to-indonesia");
      formData.append("limit", questionsConfig.limit?.toString() || "5");
      formData.append("level", questionsConfig.level || "mix");

      const questions = await generateWordGuessQuestions(formData);
